...
usesub PhoClient::Object;

use PhoClient::ApiClient;

=head1 Name

	PhoClient::ApiFactory - constructs APIs to retrieve PhoClient objects
...
=head1 Synopsis
	...
	my $api_factory = PhoClient::ApiFactory->new( ... ); # any args for ApiClient constructor
							  
	# later...
	my $pet_api = $api_factory->get_api('Pet');  
	
	# $pet_api isa PhoClient::PetApi
...
sub new {
    my ($class, %p) = (shift, @_);
	$p{api_client} = PhoClient::ApiClient->instance(%p);			
