...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'PhoClient::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'Social Graph API',
                          app_version => '1.1.1',
                          generated_date => '2017-09-04T09:06:49.168Z',
...
sub _build_af {
	...
	return PhoClient::ApiFactory->new(%args);
}
...
=head2 Social Graph API version: 1.1.1
...
=item Build date: 2017-09-04T09:06:49.168Z
...
The tokens will be placed in the C<PhoClient::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$PhoClient::Configuration::username>

String. The username for basic auth.

=item C<$PhoClient::Configuration::password>

String. The password for basic auth.

=item C<$PhoClient::Configuration::api_key>
...
=item C<$PhoClient::Configuration::api_key_prefix>
...
=item C<$PhoClient::Configuration::access_token>
